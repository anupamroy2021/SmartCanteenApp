...
public class EditProductActivity extends AppCompatActivity {
    ...
    //ui views
    private ImageView productIconIv,backBtn;
    ...
    private String productTitle,productDescription,productCategory,productQuantity,productOriginalPrice;
    private void inputData() {
        ...
        productOriginalPrice = priceEt.getText().toString().trim();
    ...
    private void updateProduct() {
        ...
        if (image_uri == null) {
            ...
            hashMap.put("productPrice",""+productOriginalPrice);
